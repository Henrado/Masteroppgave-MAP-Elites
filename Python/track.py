...
if __name__ == "__main__":
    ...
    ex_names = ["CS0", "CS1","CS5","HCS2","HCS5"]
    base_dir_real = "../../Master_Resultater/FysiskTestTimescale/Miljo/Mocap/"
    base_dir_sim  = "../../Master_Resultater/FysiskTestTimescale/Miljo/Sim/"

    ex_names = ["G_S_B", "G_SUfq_B", "G_T_B", "G_TWoff_B", "G_TWoffFq_B"]
    ex_names = ["T_SUfq_B", "T_T_B", "T_TWoff_B"]
    ex_names = ["Z_S_B", "Z_SUfq_B", "Z_T_B", "Z_TWoff_B", "Z_TWoffFq_B"]
    base_dir_real = "../../Master_Resultater/FysiskTestTimescale/Determ/Mocap/"
    base_dir_sim  = "../../Master_Resultater/FysiskTestTimescale/Determ/Sim/"
