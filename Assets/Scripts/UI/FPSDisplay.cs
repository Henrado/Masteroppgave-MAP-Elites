...
public class FPSDisplay : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 10, 200, 50), "Update: " + updateUpdateCountPerSecond.ToString(), fontSize);
        GUI.Label(new Rect(10, 60, 200, 50), "FixedUpdate: " + updateFixedUpdateCountPerSecond.ToString(), fontSize);
    }
